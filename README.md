...
[![Build Status](https://secure.travis-ci.org/getyourguide/oauth2_proxy.svg?branch=master)](http://travis-ci.org/getyourguide/oauth2_proxy)
...
1. Download [Prebuilt Binary](https://github.com/getyourguide/oauth2_proxy/releases) (current release is `v2.2`) or build with `$ go get github.com/getyourguide/oauth2_proxy` which will put the binary in `$GOROOT/bin`
...
Usage of oauth2_proxy:
  ...
  -set-id-token: set X-Forwarded-Id-Token response headers (useful in Nginx auth_request mode)
